...
t_aabb				constant_medium_bounding_box(
						const t_constant_medium *medium);
t_constant_medium	*constant_medium_create_color(
						const t_hittable_wrapper *boundary, real_t density,
						t_color albedo);
t_constant_medium	*constant_medium_create_texture(
						const t_hittable_wrapper *boundary, real_t density,
						t_texture *tex);
bool				constant_medium_hit_noobj(const t_ray *r,
						t_interval rayt, t_hit_record *rec);
bool				constant_medium_hit(const t_constant_medium *medium,
