...
void set_face_normal(t_hit_record *hit, const t_ray *r, const t_vec3 *outward_normal);
t_rotate_y_wrap *rotate_y_create(const t_hittable_wrapper *child, real_t angle_deg);
bool rotate_y_hit_noobj(const t_ray *r, t_interval rayt, t_hit_record *rec);
void set_current_rotate(const void *obj);
t_translate_wrap *translate_create(const t_hittable_wrapper *child, const t_vec3 *offset);
