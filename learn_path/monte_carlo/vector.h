...
/*   Updated: 2026/01/04 16:56:42 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * monte carlo program is a randomized algorithms a monte carlo program will
 * give a statistical estimate of an answer, and this estimate will get more
 * and more acurate the longer we run it. Whihc means that as certain point, 
 * we can just decide that the answer is accurate enough and call it quits.
 * This basic characteristic of simple programs producing noiy but ever-better
 * answers is waht Monte Carlo is all about, and is especially good for application
 * where great accuracy is needed.
 */
